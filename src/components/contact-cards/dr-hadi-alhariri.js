...
const DrHadiAlhariri = () => {
  ...
  const doctorInfo = {
    title: currentLanguage === 'AR' ? "د.هادي نذير الحريري" : "Dr.Hadi Nazeer Al Hariri",
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <a 
              href={getWhatsAppWebUrl('963965294724')}
              onClick={handleWhatsAppClick('963965294724')}
