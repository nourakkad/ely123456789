...
const PORTFOLIO_URL = 'https://drive.google.com/drive/folders/1Bujl85VJWKSTBQxJcbq_H6T4CbvOR7nI';
const WA_ID = '963996592941';
...
const OsamaAzmeh = () => {
  ...
  const btnBase = {
    ...
    padding: '12px',
    borderRadius: '50%',
    boxShadow: '0 4px 12px rgba(18, 18, 18, 0.35)',
  ...
  const onBtnOver = (e) => {
    ...
    e.currentTarget.style.boxShadow = '0 6px 16px rgba(18, 18, 18, 0.45)';
  };

  const onBtnOut = (e) => {
    e.currentTarget.style.backgroundColor = prim;
    e.currentTarget.style.transform = 'translateY(0)';
    e.currentTarget.style.boxShadow = '0 4px 12px rgba(18, 18, 18, 0.35)';
  };
  ...
  const downloadBtnStyle = {
    ...
    cursor: 'pointer',
    transition: 'all 0.3s ease',
    boxShadow: '0 4px 15px rgba(18, 18, 18, 0.35)',
    display: 'flex',
    alignItems: 'center',
    gap: '8px',
    letterSpacing: '0.5px',
  ...
  const onDownloadOver = (e) => {
    ...
    e.currentTarget.style.transform = 'translateY(-2px)';
    e.currentTarget.style.boxShadow = '0 6px 20px rgba(18, 18, 18, 0.4)';
  };
  ...
  const onDownloadOut = (e) => {
    ...
    e.currentTarget.style.transform = 'translateY(0)';
    e.currentTarget.style.boxShadow = '0 4px 15px rgba(18, 18, 18, 0.35)';
  };

  const contactInfo = {
    title: currentLanguage === 'AR' ? 'أسامة عظمة' : 'Osama Azmeh',
    category: currentLanguage === 'AR' ? 'مصور فيديو' : 'Videographer',
    phone: '+963 996 592 941',
    email: 'osamaazmehmma@gmail.com',
    instagram: 'https://www.instagram.com/osama_azmeh',
    instagramHandle: '@osama_azmeh',
  };
  ...
  const avatarStyle = {
    ...
    boxShadow: '0 8px 25px rgba(18, 18, 18, 0.35)',
    marginBottom: '12px',
    objectFit: 'cover',
    backgroundColor: prim,
    display: 'flex',
    ...
    <div style={{
      ...
      <div style={{
        ...
        <button
          ...
          style={{
            ...
            boxShadow: '0 4px 15px rgba(18, 18, 18, 0.2)',
            minWidth: '80px',
            textAlign: 'center',
            letterSpacing: '0.5px',
          }}
          onMouseOver={(e) => {
            ...
            e.target.style.boxShadow = '0 6px 20px rgba(18, 18, 18, 0.35)';
          }}
          onMouseOut={(e) => {
            e.target.style.backgroundColor = 'rgba(255, 255, 255, 0.9)';
            e.target.style.color = prim;
            e.target.style.transform = 'translateY(0)';
            e.target.style.boxShadow = '0 4px 15px rgba(18, 18, 18, 0.2)';
          }}
        >
      ...
      <div style={{
        ...
        <div style={{
          ...
          borderRadius: '28px',
          boxShadow: '0 25px 50px rgba(18, 18, 18, 0.25)',
          display: 'flex',
          flexDirection: 'column',
          alignItems: 'center',
          justifyContent: 'flex-end',
          ...
          <div style={{
            ...
            {showProfileImage ? (
              ...
              <div style={avatarStyle} aria-hidden="true">OA</div>
            )}
            <h2 style={{
              fontSize: '22px',
              fontWeight: '800',
          ...
          <div style={{
            ...
            <a
              ...
              onMouseOut={onDownloadOut}
            >
              <i className="fas fa-folder-open" style={{ fontSize: '16px' }} />
              {currentLanguage === 'AR' ? 'عرض معرض الأعمال' : 'View Portfolio'}
            </a>
            <a
              href={CV_PDF}
              download="Osama-Azmeh-Videographer.pdf"
              style={{ ...downloadBtnStyle, width: '100%', justifyContent: 'center' }}
              onMouseOver={onDownloadOver}
              onMouseOut={onDownloadOut}
            >
              <i className="fas fa-file-pdf-o" style={{ fontSize: '16px' }} />
              {currentLanguage === 'AR' ? 'تحميل السيرة الذاتية' : 'Download CV'}
            </a>
          </div>
          ...
          <div style={{
            ...
            borderRadius: '18px',
            border: `1px solid ${accent}`,
            boxShadow: 'inset 0 2px 4px rgba(18, 18, 18, 0.08)',
            padding: '16px',
            marginTop: '12px',
            gap: '10px',
            display: 'flex',
