...
const Elyptek = () => {
  ...
  // Matches logo12.png: black “ELY” + amber “TEK” / circuit (#F8A400)
  const c = {
    ink: '#0a0a0a',
    accent: '#F8A400',
    accentDark: '#e09600',
  ...
  const prim = c.accent;
  const primHover = c.accentDark;

  const info = {
    title: currentLanguage === 'AR' ? 'إيليبتك' : 'Elyptek',
    tagline: currentLanguage === 'AR' ? 'حلول برمجية وتقنية' : 'Software & technology',
    phoneLabel: '+963 980 325 553',
    location:
      currentLanguage === 'AR' ? 'دمشق، سوريا - الشعلان' : 'Damascus, Syria - Al-Shaalan',
  ...
  const btnBase = {
    ...
    boxShadow: `0 2px 0 0 ${c.ink}, 0 4px 14px rgba(248, 164, 0, 0.28)`,
  ...
  const onBtnOver = (e) => {
    ...
    e.currentTarget.style.borderColor = primHover;
    e.currentTarget.style.transform = 'translateY(-2px)';
  };
  const onBtnOut = (e) => {
    e.currentTarget.style.backgroundColor = c.ink;
    e.currentTarget.style.borderColor = prim;
    ...
    >
      ...
      >
        ...
        <button
          ...
          onMouseOver={(e) => {
            e.target.style.backgroundColor = c.ink;
      ...
      <div style={{ width: '100%', maxWidth: '360px', margin: '0 auto', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <div
          style={{
            ...
            borderRadius: '28px',
            boxShadow: `6px 6px 0 0 ${c.ink}, 0 20px 48px rgba(248, 164, 0, 0.1), 0 8px 24px rgba(0, 0, 0, 0.08)`,
            display: 'flex',
            flexDirection: 'column',
            alignItems: 'center',
            justifyContent: 'space-between',
        ...
        >
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%' }}>
            <img
              ...
              style={{
                ...
                boxShadow: `0 0 0 2px ${prim}, 0 0 0 5px ${c.ink}, 4px 4px 0 0 ${c.ink}`,
                marginBottom: '12px',
                objectFit: 'contain',
          ...
          <div style={{ display: 'flex', justifyContent: 'center', marginTop: '16px' }}>
            <a
              ...
              style={{
                ...
                cursor: 'pointer',
                transition: 'all 0.3s ease',
                boxShadow: `0 2px 0 0 ${c.ink}, 0 4px 16px rgba(248, 164, 0, 0.3)`,
                display: 'flex',
                alignItems: 'center',
                gap: '8px',
                letterSpacing: '0.5px',
          ...
          >
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              ...
              >
                <i className="fab fa-instagram" style={{ fontSize: '16px', color: prim }} />
              </span>
              <a href={INSTAGRAM} target="_blank" rel="noopener noreferrer" style={{ fontWeight: '600', color: c.ink, fontSize: '14px', textDecoration: 'underline' }}>
                @elyptek.co
              </a>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              ...
              >
                <i className="fas fa-link" style={{ fontSize: '12px', color: prim }} />
              </span>
              <a href={SITE} target="_blank" rel="noopener noreferrer" style={{ fontWeight: '600', color: c.ink, fontSize: '14px', textDecoration: 'underline' }}>
                elyptek.com
              </a>
            </div>
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: '10px' }}>
              ...
              >
                <svg style={{ width: '16px', height: '16px', color: prim }} fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                style={{ fontWeight: '600', color: c.ink, fontSize: '14px', textDecoration: 'underline', lineHeight: 1.45 }}
              >
                {info.location}
              </a>
            </div>
