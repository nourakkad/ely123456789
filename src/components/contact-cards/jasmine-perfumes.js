...
const JasminePerfumes = () => {
  ...
  // Logo identity: black + metallic gold
  const prim = '#0D0D0D';
  ...
  const btnStyle = {
    ...
    padding: '12px',
    borderRadius: '50%',
    boxShadow: '0 4px 12px rgba(13, 13, 13, 0.35)',
  ...
  const onBtnOver = (e) => {
    ...
    e.currentTarget.style.boxShadow = '0 6px 16px rgba(13, 13, 13, 0.45)';
  };

  const onBtnOut = (e) => {
    e.currentTarget.style.backgroundColor = prim;
    e.currentTarget.style.transform = 'translateY(0)';
    e.currentTarget.style.boxShadow = '0 4px 12px rgba(13, 13, 13, 0.35)';
  };
  ...
  const whatsAppIcon = (
    <svg style={{ width: '16px', height: '16px', color: accentLight }} fill="currentColor" viewBox="0 0 24 24">
      ...
      >
        ...
        <button
          ...
          style={{
            ...
            boxShadow: '0 4px 15px rgba(13, 13, 13, 0.2)',
            minWidth: '80px',
            textAlign: 'center',
            letterSpacing: '0.5px',
          }}
          onMouseOver={(e) => {
            ...
            e.target.style.boxShadow = '0 6px 20px rgba(13, 13, 13, 0.35)';
          }}
          onMouseOut={(e) => {
            e.target.style.backgroundColor = 'rgba(255, 255, 255, 0.9)';
            e.target.style.color = prim;
            e.target.style.transform = 'translateY(0)';
            e.target.style.boxShadow = '0 4px 15px rgba(13, 13, 13, 0.2)';
          }}
        >
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%' }}>
            <div
              style={{
                ...
                boxShadow: '0 8px 25px rgba(13, 13, 13, 0.25)',
                marginBottom: '12px',
                backgroundColor: prim,
                display: 'flex',
                alignItems: 'center',
          ...
          <div style={{ display: 'flex', justifyContent: 'center', marginTop: '16px' }}>
            <a
              ...
              style={{
                ...
                cursor: 'pointer',
                transition: 'all 0.3s ease',
                boxShadow: '0 4px 15px rgba(13, 13, 13, 0.35)',
                display: 'flex',
                alignItems: 'center',
                gap: '8px',
                letterSpacing: '0.5px',
              ...
              onMouseOut={(e) => {
                ...
                e.currentTarget.style.transform = 'translateY(0)';
                e.currentTarget.style.boxShadow = '0 4px 15px rgba(13, 13, 13, 0.35)';
              }}
            >
...
export default JasminePerfumes;
