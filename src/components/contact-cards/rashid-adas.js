...
const RashidAdas = () => {
  ...
  const doctorInfo = {
    title: currentLanguage === 'AR' ? "رشيد عدس" : "Rashid Adas",
    category: currentLanguage === 'AR' ? "مؤسس شركة القمة" : "KMA Co. Founder",
        ...
        <div style={{
          ...
          <div style={{
            ...
            <span style={{
              ...
              {currentLanguage === 'AR' ? 'مؤسس شركة القمة' : 'KMA Co. Founder'}
            </span>
          </div>
...
>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" 
    ...
    <path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 
            ...
            <a 
              href={getWhatsAppWebUrl('963933469024')}
              onClick={handleWhatsAppClick('963933469024')}
          ...
          <div style={{
            ...
            <a
              href="/assets/vcf/rashid-adas.vcf" onClick={handleVcfClick('/assets/vcf/rashid-adas.vcf')}
