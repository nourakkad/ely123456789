...
const PORTFOLIO_PDF = '/assets/pdf/WATAD Agro AR.pdf';
...
const WatadAgro = () => {
  ...
  const onBtnOver = (e) => {
    ...
    e.currentTarget.style.boxShadow = '0 6px 16px rgba(45, 106, 79, 0.45)';
  };

  const onBtnOut = (e) => {
    e.currentTarget.style.backgroundColor = prim;
    e.currentTarget.style.transform = 'translateY(0)';
    e.currentTarget.style.boxShadow = '0 4px 12px rgba(45, 106, 79, 0.35)';
  };
  ...
  const downloadBtnStyle = {
    ...
    cursor: 'pointer',
    transition: 'all 0.3s ease',
    boxShadow: '0 4px 15px rgba(45, 106, 79, 0.35)',
    display: 'flex',
    alignItems: 'center',
    gap: '8px',
    letterSpacing: '0.5px',
  ...
  const onDownloadOut = (e) => {
    ...
    e.currentTarget.style.transform = 'translateY(0)';
    e.currentTarget.style.boxShadow = '0 4px 15px rgba(45, 106, 79, 0.35)';
  };
  ...
  const contactInfo = {
    ...
    facebook: 'https://www.facebook.com/share/14jbKtyUbL1/?mibextid=wwXIfr',
    facebookLabel: 'Watad Agro Syria',
  };
    ...
    <div style={{
      ...
      <div style={{
        ...
        <button
          ...
          onMouseOver={(e) => {
            ...
            e.target.style.boxShadow = '0 6px 20px rgba(45, 106, 79, 0.35)';
          }}
          onMouseOut={(e) => {
            e.target.style.backgroundColor = 'rgba(255, 255, 255, 0.9)';
            e.target.style.color = prim;
            e.target.style.transform = 'translateY(0)';
            e.target.style.boxShadow = '0 4px 15px rgba(45, 106, 79, 0.2)';
          }}
        >
      ...
      <div style={{
        ...
        <div style={{
          ...
          borderRadius: '28px',
          boxShadow: '0 25px 50px rgba(45, 106, 79, 0.25)',
          display: 'flex',
          flexDirection: 'column',
          alignItems: 'center',
          justifyContent: 'flex-end',
          ...
          <div style={{
            ...
            <img
              ...
              style={{
                ...
                boxShadow: '0 8px 25px rgba(45, 106, 79, 0.35)',
                marginBottom: '12px',
                objectFit: 'contain',
                backgroundColor: '#fff',
                padding: '8px',
          ...
          <div style={{
            ...
            <a
              href="/assets/vcf/watad-agro.vcf"
              download="watad-agro.vcf"
          ...
          <div style={{
            ...
            borderRadius: '18px',
            border: `1px solid ${accent}`,
            boxShadow: 'inset 0 2px 4px rgba(45, 106, 79, 0.08)',
            padding: '16px',
            marginTop: '12px',
            gap: '10px',
            display: 'flex',
