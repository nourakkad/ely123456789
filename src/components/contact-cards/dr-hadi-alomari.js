...
const DrHadiAlomari = () => {
  ...
  const doctorInfo = {
    title: currentLanguage === 'AR' ? 'د. هادي العمري' : 'Dr. Hadi Alomari',
    category:
      currentLanguage === 'AR'
      ...
      >
        ...
        >
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '12px', marginTop: '16px' }}>
            ...
            <a
              href={getWhatsAppWebUrl('963992506512')}
              onClick={handleWhatsAppClick('963992506512')}
          ...
          <div style={{ display: 'flex', justifyContent: 'center', marginTop: '16px' }}>
            <a
              href="/assets/vcf/Dr_Hadi_Alomari.vcf" onClick={handleVcfClick('/assets/vcf/Dr_Hadi_Alomari.vcf')}
              download="Dr_Hadi_Alomari.vcf"
              style={{
                backgroundColor: '#ffa700',
                color: '#fff',
                border: 'none',
