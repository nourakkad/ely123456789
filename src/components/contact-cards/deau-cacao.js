      ...
      <div style={{
        ...
        <button
          ...
          style={{
            ...
            boxShadow: '0 4px 15px rgba(63, 27, 41, 0.2)',
            minWidth: '80px',
            textAlign: 'center',
            letterSpacing: '0.5px'
          }}
          onMouseOver={(e) => {
            e.target.style.backgroundColor = '#3f1b29';
            e.target.style.color = '#fff';
            e.target.style.transform = 'translateY(-2px)';
            e.target.style.boxShadow = '0 6px 20px rgba(63, 27, 41, 0.4)';
          }}
          onMouseOut={(e) => {
            e.target.style.backgroundColor = 'rgba(255, 255, 255, 0.9)';
            e.target.style.color = '#6b3d4d';
            e.target.style.transform = 'translateY(0)';
            e.target.style.boxShadow = '0 4px 15px rgba(63, 27, 41, 0.2)';
          }}
        >
          ...
          <div style={{
            ...
            <img
              ...
              style={{
                ...
                height: '100px',
                borderRadius: '50%',
                border: '4px solid #3f1b29',
                boxShadow: '0 8px 25px rgba(63, 27, 41, 0.3)',
                marginBottom: '12px',
                objectFit: 'cover'
              }}
            />
          ...
          <div style={{
            ...
            <a 
              ...
              style={{
                ...
                padding: '12px',
                borderRadius: '50%',
                boxShadow: '0 4px 12px rgba(63, 27, 41, 0.3)',
                transition: 'all 0.3s ease',
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'center',
              ...
              onMouseOver={(e) => {
                e.target.style.backgroundColor = '#5c2d3d';
                e.target.style.transform = 'translateY(-2px)';
                e.target.style.boxShadow = '0 6px 16px rgba(92, 45, 61, 0.4)';
              }}
              onMouseOut={(e) => {
                e.target.style.backgroundColor = '#3f1b29';
                e.target.style.transform = 'translateY(0)';
                e.target.style.boxShadow = '0 4px 12px rgba(63, 27, 41, 0.3)';
              }}
            >
          ...
          <div style={{
            ...
            <a
              ...
              style={{
                ...
                cursor: 'pointer',
                transition: 'all 0.3s ease',
                boxShadow: '0 4px 15px rgba(63, 27, 41, 0.3)',
                display: 'flex',
                alignItems: 'center',
                gap: '8px',
                letterSpacing: '0.5px',
              ...
              onMouseOver={(e) => {
                e.target.style.backgroundColor = '#5c2d3d';
                e.target.style.transform = 'translateY(-2px)';
                e.target.style.boxShadow = '0 6px 20px rgba(92, 45, 61, 0.4)';
              }}
              onMouseOut={(e) => {
                e.target.style.backgroundColor = '#3f1b29';
                e.target.style.transform = 'translateY(0)';
                e.target.style.boxShadow = '0 4px 15px rgba(63, 27, 41, 0.3)';
              }}
            >
            ...
            {doctorInfo.facebook && (
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  style={{ fontWeight: '600', color: '#6b3d4d', fontSize: '13px', textDecoration: 'underline' }}
                >
                  Deau Cacao 
                </a>
              </div>
