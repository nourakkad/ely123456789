...
const ShadiSaeedJassem = () => {
  ...
  const doctorInfo = {
    title: currentLanguage === 'AR' ? "شادي سعيد جاسم" : "Shadi Saeed Jassem",
    category: currentLanguage === 'AR' ? "قسم الدعم الفني في شركة القمة" : "Technical Support Department at KMA Co.",
        ...
        <div style={{
          ...
          <div style={{
            ...
            <span style={{
              ...
              {currentLanguage === 'AR' ? 'قسم الدعم الفني في شركة القمة' : 'Technical Support Department at KMA Co.'}
            </span>
          </div>
...
>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" 
    ...
    <path d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 
            ...
            <a 
              href={getWhatsAppWebUrl('963941940957')}
              onClick={handleWhatsAppClick('963941940957')}
          ...
          <div style={{
            ...
            <a
              href="/assets/vcf/shadi-saeed-jassem.vcf" onClick={handleVcfClick('/assets/vcf/shadi-saeed-jassem.vcf')}
...
export default ShadiSaeedJassem; 